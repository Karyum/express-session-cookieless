...
function session(options) {
  ...
  // should the header be set as token (X-Access-Token) instead of cookie
 ...
 * @private
 */
function setcookie(res, req, name, val, secret, options) {
